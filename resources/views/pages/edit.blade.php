                            ...
                            <form method="POST" action="{{ route('anggotas.update', $item->id_anggota) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_depan"
                                        value="{{ old('nama_depan', $item->nama_depan) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_belakang"
                                        value="{{ old('nama_belakang', $item->nama_belakang) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="gelar_depan"
                                        value="{{ old('gelar_depan', $item->gelar_depan) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="gelar_belakang"
                                        value="{{ old('gelar_belakang', $item->gelar_belakang) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jabatan"
                                        ...
                                        <option value="ketua"
                                            {{ old('jabatan', $item->jabatan) == 'ketua' ? 'selected' : '' }}>Ketua
                                        </option>
                                        <option value="wakil_ketua"
                                            {{ old('jabatan', $item->jabatan) == 'wakil_ketua' ? 'selected' : '' }}>Wakil
                                            Ketua</option>
                                        <option value="anggota"
                                            {{ old('jabatan', $item->jabatan) == 'anggota' ? 'selected' : '' }}>Anggota
                                        </option>
                                    </select>
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <form method="POST" action="{{ route('komponen_gajis.update', $item->id_komponen_gaji) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_komponen"
                                        value="{{ old('nama_komponen', $item->nama_komponen) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kategori"
                                        class="{{ $errors->has('kategori') ? 'border-red' : '' }} form-control" required>
                                        <option value="">-- Pilih --</option>
                                        <option value="gaji_pokok"
                                            {{ old('kategori', $item->kategori) == 'gaji_pokok' ? 'selected' : '' }}>Gaji
                                            Pokok
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jabatan"
                                        ...
                                        <option value="semua"
                                            {{ old('jabatan', $item->jabatan) == 'semua' ? 'selected' : '' }}>Semua
                                        </option>
                                    </select>
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="satuan"
                                        ...
                                        <option value="">-- Pilih --</option>
                                        <option value="bulan"
                                            {{ old('satuan', $item->satuan) == 'bulan' ? 'selected' : '' }}>Bulan</option>
                                        <option value="periode"
                                            {{ old('satuan', $item->satuan) == 'periode' ? 'selected' : '' }}>Periode
                                        </option>
                                    </select>
                                    @error('satuan')
                                        <div class="invalid-feedback">{{ $message }}</div>
